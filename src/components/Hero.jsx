    ...
    <div className="hero-content text-center">
      <div className="max-w-xl">
        ...
        <p className="py-6 text-2xl max-md:text-lg text-accent-content">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto corporis error rem fugiat, harum, tempora tenetur dignissimos illum suscipit excepturi consequuntur quibusdam, ducimus temporibus id!
        </p>
